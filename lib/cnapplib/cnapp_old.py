...
class CNApp(Gtk.Application):
    ...
    # --------------------------------------------------------------------------
    def __init__(self, app_id, dict_app, dict_state=None):
        """
        Initialize the new object
        ...
        Methods:
            ...
            get_dict_state: Return the backing dict of all windows,
        ...
        if not app_id:
            # no app_id or app_id is empty
            raise IOError(AC.ERR_APP_ID)
        ...
        # set dict_state param to something
        if dict_state is None:
            dict_state = {}
    ...
    def _activate(self, _obj):
        ...
        for name_win, dict_win in self._dict_state.items():
