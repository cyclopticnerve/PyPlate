...
def main(debug=False):
    ...
    try:
        ...
        # fix desktop icon
        desk_file = Path("__PP_INST_ASSETS__") / "__PP_FILE_DESK__"
        # inst.fix_desktop_icon(desk_file)

        inst.install(DIR_ASSETS, FILE_CFG_NEW, FILE_CFG_OLD, desk_file=desk_file, debug=debug)
