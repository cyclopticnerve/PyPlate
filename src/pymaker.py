...
# ------------------------------------------------------------------------------
# The main class that implements PyMaker
# ------------------------------------------------------------------------------
class PyMaker:
    """
    The main class that implements PyMaker
    ...
    def main(self):
        ...
        Main entry point for the program, initializing the program, and
        performing its steps.
        """

        # fix help string/toml file
        self._fix_help_and_toml()

        # get cmd line args
        self._dict_args = self._setup_parser()
        ...
        # tell user we updated
        print(S.S_PRJ_UPDATE.format(S.DIR_LIB))

        # check for update flag
        if self._dict_args.get(S_UPD_DEST, False):
    ...
    # ------------------------------------------------------------------------------
    def do_before_fix(self):
        """
        Copy/create any other files before running do_fix

        Adds dirs/files to the project before running the fix method.
        """
    ...
    def _fix_header(self, path):
        ...
        (see the header in this file for an example). Adapting this method to your
